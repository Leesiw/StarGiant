...
{
	return(CShader::CompileShaderFromFile(L"fire_vs.hlsl", "FireVertexShader", "vs_5_1", &m_pd3dVertexShaderBlob));
}

D3D12_SHADER_BYTECODE CFireShader::CreatePixelShader()
{
	return(CShader::CompileShaderFromFile(L"fire_ps.hlsl", "FirePixelShader", "ps_5_1", &m_pd3dPixelShaderBlob));
}
