...
{
public:
	CPlaneMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, float fWidth = 1.0f, float fHeight = 1.0f, float fDepth = 1.0f, XMFLOAT2 xmf2LeftTop = XMFLOAT2(0.f, 0.f), XMFLOAT2 xmf2LeftBot = XMFLOAT2(0.f, 0.f), XMFLOAT2 xmf2RightBot = XMFLOAT2(0.f, 0.f), XMFLOAT2 xmf2RightTop = XMFLOAT2(0.f, 0.f), float fAddrX = 1.f, float fAddrY = 1.f);
	virtual ~CPlaneMesh();
