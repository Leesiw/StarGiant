...
void CCamera::OrthogonalProjectionMatrix(float fNearPlaneDistance, float fFarPlaneDistance, float fw, float fh)
{
	m_xmf4x4OrthogonalProjection = Matrix4x4::OrthoLH(fw, fh, fNearPlaneDistance, fFarPlaneDistance);
}
