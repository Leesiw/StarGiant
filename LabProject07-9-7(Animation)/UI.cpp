...
void UILayer::Resize(ID3D12Resource** ppd3dRenderTargets, UINT nWidth, UINT nHeight)
{
    ...
    m_pd2dWriteFactory->CreateTextFormat(L"굴림체", nullptr, DWRITE_FONT_WEIGHT_MEDIUM, DWRITE_FONT_STYLE_ITALIC, DWRITE_FONT_STRETCH_NORMAL, fFontSize_Scripts, L"en-us", &m_pdwBossScriptsFormat);
    ...
    m_pd2dWriteFactory->CreateTextFormat(L"굴림체", nullptr, DWRITE_FONT_WEIGHT_MEDIUM, DWRITE_FONT_STYLE_NORMAL, DWRITE_FONT_STRETCH_NORMAL, fFontSize_Lobby, L"en-us", &m_pdwLobbyFormat);
    ...
    m_pd2dWriteFactory->CreateTextFormat(L"굴림체", nullptr, DWRITE_FONT_WEIGHT_MEDIUM, DWRITE_FONT_STYLE_NORMAL, DWRITE_FONT_STRETCH_NORMAL, fFontSize_MatchingLobby, L"en-us", &m_pdwLobbyMatchingFormat);
    ...
    m_pd2dWriteFactory->CreateTextFormat(L"굴림체", nullptr, DWRITE_FONT_WEIGHT_MEDIUM, DWRITE_FONT_STYLE_NORMAL, DWRITE_FONT_STRETCH_NORMAL, fFontSize_Skip, L"en-us", &m_pdwSkipFormat);
